...
vector<int> mobility_buffer;
vector<int> potMobility_buffer;
vector<int> makeup_buffer;
vector<int> naivety_buffer;
vector<int> parity_buffer;
vector<int> corners_buffer;
vector<int> stability_buffer;
...
void heuristicEvaluation::heuristic5_gpu(othelloBoard board, int nSpacesRemaining,int symbol) {
    // do heuristic from perspective of player with p.symbol = 1
    int val = 0;
    vector <int> positions = board.positions;
    ...
    mobility_buffer.push_back(mobility);
    potMobility_buffer.push_back(potMobility);
    makeup_buffer.push_back(makeup);
    naivety_buffer.push_back(naivety);
    parity_buffer.push_back(parity);
    corners_buffer.push_back(corners);
    stability_buffer.push_back(stability);
    //return 5*mobility + 2*potMobility + makeup + 5*naivety + 500*parity + 1000*corners + 1000*stability;
}
...
void heuristicEvaluation::heuristic_gpu(othelloBoard board, int nSpacesRemaining,int symbol) {
    heuristic5_gpu(board, nSpacesRemaining,symbol);
    return;
}
